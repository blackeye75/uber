...
const Home = () => {
    return (
        <div className='bg-[url("https://images.unsplash.com/photo-1567536303373-0eb3957ba696?q=80&w=1888&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")] bg-cover bg-no-repeat  h-screen pt-5  w-full flex justify-between flex-col  bg-red-400' >
